...
const Wrapper = styled.div<{ $border?: string }>`
    ...
    .tags-input-container {
        ...
        border-radius: 8px;
        background: #ffffff;
        border: ${(props) => props.$border || '1px solid #6b7280'};
...
export const FormInput = ({
    ...
    const customStyles = {
        ...
        option: (base: any, state: any) => ({
            ...base,
            display: 'flex',
            backgroundColor: state.isFocused ? '#0069d9' : null,
            color: state.isFocused ? 'white' : null,
            '&:hover': {
                backgroundColor: state.isFocused ? '#0069d9' : '#f8f9fa',
                    ...
                    <InputGroup>
                        {type === 'select' && (
                            <Select
                                ...
                                className={`${className} app_selects`}
                            />
                        )}
                        {type === 'file' && (
                            <FileInput
                                ...
                                defaultValue={value}
                                className={`${className} app_file_input`}
                        ...
                        {type === 'input' && (
                            <OtpInput
                                ...
                                value={value}
                                onChange={(otp: string) => {
                                    if (changeEventHandler && !stateHandler) {
                                        changeEventHandler(otp);
                                    } else if (
                                        stateHandler &&
                                        !changeEventHandler
                                    ) {
